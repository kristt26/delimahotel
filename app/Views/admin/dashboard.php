            ...
            <div class="card tale-bg">
                <div class="card-people mt-auto">
                    ...
                    <div class="weather-info">
                        <div class="d-flex">
                            <div>
                                <h2 class="mb-0 font-weight-normal"><i class="icon-sun mr-2"></i>{{temp.main.temp}}<sup>o</sup>C</h2>
                            </div>
                            <div class="ml-2">
                                <h4 class="location font-weight-normal">{{temp.name}}</h4>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-tale">
                        <div class="card-body">
                            ...
                            <p class="fs-30 mb-2">{{datas.this}}</p>
                            <!-- <p>10.00% (30 days)</p> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-dark-blue">
                        <div class="card-body">
                            ...
                            <p class="fs-30 mb-2">{{datas.all}}</p>
                            <!-- <p>22.00% (30 days)</p> -->
                        </div>
                    </div>
                </div>
