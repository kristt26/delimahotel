...
<div ng-controller="laundryController">
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Data Laundry</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" ng-submit="save()">
                        <div class="form-group">
                            <label for="laundry">Jenis Laundry</label>
                            <input type="text" class="form-control form-control-sm" ng-model="model.laundry" placeholder="Jenis Laundry">
                        </div>
                        <div class="form-group">
                            <label>Price</label>
                            <div class="form-group">
