            ...
            <div class="card-body">
                <nav class="d-flex justify-content-between">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" ng-click="setTabs('Reservasi')" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Check In</a>
                        ...
                        <a class="nav-item nav-link" id="nav-contact-tab" ng-click="setTabs('Inap')" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Check Out</a>
                    </div>
